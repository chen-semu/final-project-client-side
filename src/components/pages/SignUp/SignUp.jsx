...
import { signUpUser } from '../../services/usersDB';
...
export default function SignUp() {
  ...
  async function emailValidationApi(email) {
    try {
      return await fetch(
  ...
  const handleSubmit = (event) => {
    ...
    console.log( data.get('firstName'),'bhjh');
    reactionToEmailValidation({
      fullName: data.get('firstName'),
      email: data.get('email'),
      password: data.get('password'),
      passwordRep: data.get('passwordRep')
    });
  };
